...
void geometry_deduplicate_vertices(u32 vertex_count, vertex_3d* vertices, u32 index_count, u32* indices, u32* out_vertex_count, vertex_3d** out_vertices) {
    ...
    vertex_3d* unique_verts = (vertex_3d*)(KMemory::allocate(sizeof(vertex_3d) * vertex_count, MEMORY_TAG_ARRAY));
    *out_vertex_count = 0;
    ...
    *out_vertices = static_cast<vertex_3d*>(KMemory::allocate(sizeof(vertex_3d) * (*out_vertex_count), MEMORY_TAG_ARRAY));
    // Copy over unique
    KMemory::copy_memory(*out_vertices, unique_verts, sizeof(vertex_3d) * (*out_vertex_count));
    // Destroy temp array
    KMemory::free(unique_verts, sizeof(vertex_3d) * vertex_count, MEMORY_TAG_ARRAY);
