...
b8 renderer_system_initialize(u64* memory_requirement, void* state, const char* application_name) {
    *memory_requirement = sizeof(renderer_system_state);
    ...
    pass_configs[0].render_area = {0, 0, 1280, 720};
    pass_configs[0].clear_colour = {0.0f, 0.0f, 0.2f, 1.0f};
    ...
    pass_configs[1].render_area = {0, 0, 1280, 720};
    pass_configs[1].clear_colour = {0.0f, 0.0f, 0.2f, 1.0f};
    ...
    pass_configs[2].render_area = {0, 0, 1280, 720};
    pass_configs[2].clear_colour = {0.0f, 0.0f, 0.2f, 1.0f};
    ...
    state_ptr->skybox_renderpass->targets = (render_target*)KMemory::allocate(sizeof(render_target) * state_ptr->window_render_target_count, MEMORY_TAG_ARRAY);
    ...
    state_ptr->world_renderpass->targets = (render_target*)KMemory::allocate(sizeof(render_target) * state_ptr->window_render_target_count, MEMORY_TAG_ARRAY);
    ...
    state_ptr->ui_renderpass->targets = (render_target*)KMemory::allocate(sizeof(render_target) * state_ptr->window_render_target_count, MEMORY_TAG_ARRAY);
